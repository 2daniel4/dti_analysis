...
#Make registration map between b0 volume and anatomical
bbregister --s ${subj}.${cond} --mov /Volumes/DANIEL/dti_freesurf/dtrecon/${cond}.${subj}/lowb.nii.gz --reg /Volumes/DANIEL/dti_freesurf/dtrecon/${cond}.${subj}/register.dat --t2
